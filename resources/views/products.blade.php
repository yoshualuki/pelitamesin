            ...
            <div class="col-lg-9">
                        ...
                        @foreach ($products as $product)
                            <div class="product-card card">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <p class="card-text text-muted small mb-2">{{ Str::limit($product->description, 50) }}
                                    </p>
                                    <p class="card-text fw-bold text-primary mb-3">Rp
                ...
                @else
                    <div class="text-center py-5">
                        <img src="{{ asset('images/empty-product.svg') }}" alt="No products" style="max-width: 300px;"
                            class="mb-4">
                        <h5>Produk tidak ditemukan</h5>
                        <p class="text-muted">Coba gunakan filter yang berbeda atau <a href="{{ route('products') }}">reset
                                filter</a></p>
                    </div>
                @endif
            </div>
            ...
            $('.add-to-cart').click(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        // Reset button state
                        $btn.html('<i class="fas fa-cart-plus"></i> Tambah ke Keranjang').prop(
                            'disabled', false);
                    },
                    error: function(xhr) {

                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if (request()->is('cart*')) active @endif" href="{{ route('cart') }}"
                            ...
                            @if (session()->get('cart'))
                                <span id="cart-count" class="badge bg-primary ms-1">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" href="{{ route('orders') }}"><i
                                        class="fas fa-clipboard-list me-2"></i> Pesanan Saya</a></li>
                            <li>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="payment-methods">
                        <img src="{{ asset('images/payment/bca.webp') }}" alt="BCA" class="me-2"
                            height="30">
                        <img src="{{ asset('images/payment/mandiri.webp') }}" alt="Mandiri" class="me-2"
                            height="30">
                        <img src="{{ asset('images/payment/bni.jpeg') }}" alt="BNI" class="me-2"
                            height="30">
                        <img src="{{ asset('images/payment/visa.webp') }}" alt="VISA" class="me-2"
                            height="30">
                        <img src="{{ asset('images/payment/mastercard.webp') }}" alt="MasterCard" class="me-2"
                            height="30">
                    </div>
                </div>
            </div>

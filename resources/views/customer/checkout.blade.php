                            ...
                            <div class="row align-items-center mb-3 pb-3 border-bottom">
                                ...
                                <div class="col-md-3 text-end">
                                    <p class="mb-0 fw-bold">Rp
                                        {{ number_format($product->price * $product->quantity, 0, ',', '.') }}</p>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="card-body">
                        <form id="checkoutForm">
                            ...
                            <div class="d-grid gap-2 mt-4">
                                <button id="pay-button" type="button" class="btn btn-primary">Proceed to
                                    Payment</button>
            ...
            $("#pay-button").on('click', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        window.snap.pay(response.snapToken, {
                            onSuccess: function(result) {
                                window.location.href = '/orders/' + response
                                    .orderId;
                            },
                    ...
                    error: function(xhr) {
                        ...
                        showSwalError('Failed to update customer information: ' + xhr
